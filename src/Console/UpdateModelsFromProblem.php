...
class UpdateModelsFromProblem extends Command
{
  /**
   ...
   * @var string
   */
  protected $signature = 'piton:update_models_from_problem {problem} {author} {learner} {algorithm?}';
   ...
   * @var string
   */
  protected $description = 'Create rule based models for a specified problem using a specified learner and, eventually, algorithm.' . "\n"
