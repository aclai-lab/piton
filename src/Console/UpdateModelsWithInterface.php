...
class UpdateModelsWithInterface extends Command
{
   ...
   * @var string
   */
  protected $signature = 'piton:update_models_with_interface';
  ...
  public function handle(DBFit $db_fit)
  {
    ...
    $learner = $this->ask('Please insert the Learner you\'d like to use.' . "\n"
    ...
    if ($learner === 'PRip') {
      ...
      $algorithm = $this->ask('Please insert the classification algorithm you\'d like to use.' . "\n"
